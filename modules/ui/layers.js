...
function drawHeightmap() {
  DEBUG && console.time("drawHeightmap");
  terrs.selectAll("*").remove();
  ...
  DEBUG && console.timeEnd("drawHeightmap");
}
...
function drawTemp() {
  ...
  DEBUG && console.timeEnd("drawTemp");
}
...
function drawCultures() {
  DEBUG && console.time("drawCultures");
  ...
  DEBUG && console.timeEnd("drawCultures");
}
...
function drawReligions() {
  DEBUG && console.time("drawReligions");
  ...
  DEBUG && console.timeEnd("drawReligions");
}
...
function drawStates() {
  ...
  invokeActiveZooming();
  DEBUG && console.timeEnd("drawStates");
}

// draw state and province borders
function drawBorders() {
  DEBUG && console.time("drawBorders");
  ...
  DEBUG && console.timeEnd("drawBorders");
}
...
function drawProvinces() {
  DEBUG && console.time("drawProvinces");
  ...
  DEBUG && console.timeEnd("drawProvinces");
}
...
function drawGrid() {
  ...
  DEBUG && console.timeEnd("drawGrid");
}
