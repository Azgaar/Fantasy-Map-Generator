...
function selectStyleElement() {
  ...
  // filter
  if (!["landmass", "legend"].includes(sel)) {
...
function applyDefaultStyle() {
  ...
  regions.attr("filter", null);
  statesBody.attr("opacity", 0.4);
