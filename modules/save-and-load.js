...
async function saveSVG() {
  ...
  DEBUG && console.timeEnd("saveSVG");
}

// download map as PNG
async function savePNG() {
  DEBUG && console.time("savePNG");
  ...
  DEBUG && console.timeEnd("savePNG");
}

// download map as JPEG
async function saveJPEG() {
  DEBUG && console.time("saveJPEG");
  const url = await getMapURL("png");
  ...
  DEBUG && console.timeEnd("saveJPEG");
}
...
function getMapData() {
  DEBUG && console.time("createMapDataBlob");
  ...
  return new Promise(resolve => {
    ...
    DEBUG && console.timeEnd("createMapDataBlob");
    resolve(blob);
  });
