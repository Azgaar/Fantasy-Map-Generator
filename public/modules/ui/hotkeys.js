...
function handleKeyup(event) {
  ...
  else if (code === "KeyO" && findEl("canvas3d")) toggle3dOptions();
  else if (ctrl && code === "KeyQ") toggleSaveReminder();
  else if (ctrl && code === "KeyS") window.lazy.save().then(m => m.saveMap("machine"));
  else if (ctrl && code === "KeyC") window.lazy.save().then(m => m.saveMap("dropbox"));
  ...
  else if ((shift || altShift) && code === "KeyN") window.lazy.namesbaseEditor().then(m => m.NamesbaseEditor.open());
  ...
  else if ((shift || altShift) && code === "KeyA") window.lazy.chartsOverview().then(m => m.ChartsOverview.open());
  ...
  else if ((shift || altShift) && code === "KeyG") window.lazy.goodsEditor().then(m => m.GoodsEditor.open());
