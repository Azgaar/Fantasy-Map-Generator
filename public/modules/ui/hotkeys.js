...
function handleKeyup(event) {
  ...
  else if ((shift || altShift) && code === "KeyN") window.lazy.namesbaseEditor().then(m => m.open());
  ...
  else if ((shift || altShift) && code === "KeyA") window.lazy.chartsOverview().then(m => m.open());
  ...
  else if ((shift || altShift) && code === "KeyG") window.lazy.goodsEditor().then(m => m.open());
