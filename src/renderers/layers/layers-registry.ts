// Global layers registry: owns layer state, layer order and the svg skeleton
...
class LayersRegistry {
  ...
  init(): void {
    for (const layer of this.layers) {
      ...
      this.setVisible(group, this.active.has(layer));
    }
  }
  ...
  private eraseContent(layer: Layer): void {
