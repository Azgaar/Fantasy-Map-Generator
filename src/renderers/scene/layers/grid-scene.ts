...
const PATTERNS: Record<GridPatternType, PatternTemplate> = {
  square: { height: 25, segments: segments([[25, 0], [0, 0], [0, 25]]), width: 25 },
  pointyHex: {
    height: 43.4,
    segments: segments(
      [[0, 0], [12.5, 7.2], [25, 0]],
      [[12.5, 21.7], [12.5, 7.2]],
      [[0, 43.4], [0, 28.9], [12.5, 21.7], [25, 28.9], [25, 43.4]]
    ),
    width: 25
  },
  flatHex: {
    height: 25,
    segments: segments(
      [[43.4, 0], [36.2, 12.5], [43.4, 25]],
      [[21.7, 12.5], [36.2, 12.5]],
      [[0, 0], [14.5, 0], [21.7, 12.5], [14.5, 25], [0, 25]]
    ),
    width: 43.4
  },
  square45deg: {
    height: 35.355,
    segments: segments([[0, 0], [35.355, 35.355]], [[0, 35.355], [35.355, 0]]),
    width: 35.355
  },
  squareTruncated: {
    height: 25,
    segments: segments(
      [[8.33, 25], [0, 16.66], [0, 8.33], [8.33, 0], [16.66, 0], [25, 8.33]],
      [[16.66, 25], [25, 16.66], [25, 8.33]],
      [[8.33, 25], [16.66, 25]]
    ),
    width: 25
  },
  ...
  triangleHorizontal: {
    height: 72.33,
    segments: segments(
      [[41.76, 36.165], [0, 36.165], [20.88, 0], [41.76, 36.165], [20.88, 72.33], [0, 36.165]],
      [[0, 0], [41.76, 0]],
      [[0, 72.33], [41.76, 72.33]]
    ),
    width: 41.76
  ...
  triangleVertical: {
    height: 41.76,
    segments: segments(
      [[36.165, 0], [0, 20.88], [36.165, 41.76], [72.33, 20.88], [36.165, 0], [36.165, 41.76]],
      [[0, 0], [0, 41.76]],
      [[72.33, 0], [72.33, 41.76]]
    ),
    width: 72.33
  ...
  trihexagonal: {
    height: 43.4,
    segments: segments([[25, 10.85], [0, 10.85], [18.85, 43.4], [25, 32.55], [0, 32.55], [18.85, 0], [25, 10.85]]),
    width: 25
  },
  rhombille: {
    height: 50,
    segments: segments(
      [[13.8, 50], [0, 25], [13.8, 0], [41.2, 0], [27.5, 25], [41.2, 50], [55, 25], [41.2, 0], [68.8, 0], [82.5, 25], [68.8, 50]],
      [[0, 25], [27.5, 25]],
      [[55, 25], [82.5, 25]],
      [[13.8, 50], [41.2, 50], [68.8, 50]]
    ),
    width: 82.5
  }
};
