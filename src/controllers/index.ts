...
export const Controllers = createRegistry({
  ...
  JourneysOverview: () => import("@/controllers/journeys-overview").then(m => m.JourneysOverview),
  JourneyEditor: () => import("@/controllers/journey-editor").then(m => m.JourneyEditor),
  TransportTypesEditor: () => import("@/controllers/transport-types-editor").then(m => m.TransportTypesEditor),
