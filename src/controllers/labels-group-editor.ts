...
function submitForm(event: Event): void {
  ...
  Options.set(o => {
    o.labels.groups = rows.map(rowToGroup);
    o.labels.resizeOnZoom = ensureEl<HTMLInputElement>("labelsResizeOnZoom").checked;
    o.labels.showAll = ensureEl<HTMLInputElement>("labelsShowAll").checked;
  });
