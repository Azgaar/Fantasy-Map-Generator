  ...
  getNameBases(): NameBase[] {
    ...
    return [
      ...
      },
      {
        ...
        d: "",
        m: 0,
        b: "Etherea,Sylphus,Aetheris,Zephyrion,Ventus,Cyclone,Galea,Tempestrix,Whirlwind,Vortexia,Aerilis,Pneuma,Atmos,Nuance,Fugue,Symphonix,Fluttera,Plume,Crescendo,Decrescendo,Murmura,Echo,Resonance,Phoebe,Lumen,Radiance,Aurora,Dazzle,Lumina,Nocturne,Moonbeam,Eclipse,Phantasma,Mirage,Nebula,Aura,Zephyrion,Ventus,Cyclone,Galea,Tempestrix,Whirlwind,Vortexia,Aerilis,Pneuma,Atmos,Nuance,Fugue,Symphonix,Fluttera,Plume,Crescendo,Decrescendo,Murmura,Echo,Resonance,Phoebe,Lumen,Radiance,Aurora,Dazzle"
      },
      {
        name: "Canopy",
        i: 44,
        ...
        d: "",
        m: 0,
        b: "CanopyWhisperer,CanopyEggling,CanopyFlightcaller,CanopyMistweaver,CanopyLeafsong,CanopyTalonshower,CanopyShadebender,CanopyGalewhirl,CanopyRaindrifter,CanopySunbeam,CanopyBreezechaser,CanopyWispwhisper,CanopyShadowglide,CanopyWhirlwind,CanopyMoonflight,CanopyStarweaver,CanopyWindwisp,CanopyLeafshadow,CanopyCloudsong,CanopyFernwhisper,CanopyMossdrifter,CanopyBoughshaker,CanopyLeaflure,CanopyGrovecaller,CanopyWoodglide,CanopyForestwalker,CanopyTreevoice,CanopyWindyecho,CanopyLeafdance,CanopyBreezeflyer,CanopyWhisperroot,CanopyMistwhirl,CanopyShadeleaf,CanopySunray,CanopyBoughdream,CanopyLeaftouch,CanopyGrovecaller,CanopyWindshimmer,CanopyLeafwhisper,CanopyForestglide,CanopyTreebreeze,CanopyWoodvoice,CanopyWhisperbough,CanopyMistweaver,CanopyShadowglow,CanopySunlight,CanopyFerndream,CanopyBoughsong,CanopyLeaflight,CanopyGrovewhisper,CanopyWindleaf,CanopyLeafshimmer,CanopyForestecho,CanopyTreewhisper,CanopyWoodshade,CanopyMistdrift,CanopyShadebreeze"
      },
      {
        name: "Devils Island",
        i: 45,
        ...
        d: "",
        m: 0,
        b: "Blisterthorn,Gutterglare,Scorchspire,Grindstone,Charlock,Scorchedwaste,Flaretooth,Embergrin,Ashmaw,Charnest,Searoar,Pyroknight,Incinerate,Blazefist,Cindershadow,Flametongue,Scorcher,Ignitewraith,Burnhelm,Blazeeye,Flamerush,Scorchingwind,Infernothorn,Emberfury,Charlash,Scorchedflame,Firebrand,Ashfire,Torchheart,Embertrail,Blazeflare,Glowinggore,Charredspike,Scorchedjaw,Pyrewhisker,Blazebeard,Incineratear,Burntongue,Flamerush,Searoak,Scorchingwind,Flametornado,Ashfirestorm,Infernothicket,Embertrailblaze,Blazefireburst,Charlockflame,Scorchedember,Firebrandash,Torchheartglow,Embertrailflare,Blazeflarestorm"
      },
      {
        name: "Dusk Husk",
        i: 46,
        ...
        d: "",
        m: 0,
        b: "DuskWhisper,DuskScourge,DuskGloom,DuskFoe,DuskShade,DuskHuntress,DuskReaver,DuskSorrow,DuskBane,DuskShadow,DuskVile,DuskTerror,DuskWraith,DuskNemesis,DuskCurse,Duskbane,DuskMist,DuskFury,DuskBlade,DuskGrip,DuskGloomwalk,DuskWhirlwind,DuskReaper,DuskEclipse,DuskCrimson,DuskWoe,DuskShadowkin,DuskNightmare,DuskHorror,DuskVexation,DuskSigh,DuskFang,DuskTaint,DuskSilence,DuskCurfew,DuskWhisperer,DuskEnder,DuskGripofnight,DuskShadowflame,DuskWraithwalk,DuskBlight,DuskVeil,DuskCrimsonwhisper,DuskEclipsepath,DuskShadowsong,DuskSilentwhisper,DuskNightsnare,DuskWhisperblade,DuskGloomwhisper,DuskNightshade,DuskShadowwhirl,DuskWraithwhisper"
      },
      {
        name: "Eastern Hounds",
        i: 47,
        ...
        d: "",
        m: 0,
        b: "Blizzardhowl,Frostsnarl,Icewhisper,Snowfury,Windroar,Frostclaw,Winterfang,Icestalker,Snowstorm,Frostglide,Galepelt,Snowhide,Blizzardrush,Frostgnome,Iceprowl,Snowlash,Froststrike,Icetorrent,Frostwhirl,Coldshadow,Snowscream,Frostshout,Icestingler,Snowcrusher,Frostbite,Icestalker,Stormfrost,Iceshadow,Snowstormbringer,Frostwhisperer,Snowflayer,Frostmender,Icetwilight,Snowhowl,Frostprowler,Snowthunder,Frostglide,Iceclaw,Snowspine,Frostbite,Icestalker,Snowlasher,Frostshaper,Iceshadow,Snowfury,Frostgnome,Icestinger,Snowglider,Frostwhirl,Snowflurry,Frostprowler,Icestrike,Snowthunderer,Frostshout,Snowstormbringer,Frostgnome,Icestalker,Snowcrusher,Frostbite,Iceclaw,Snowspine,Frostmender,Frostshaper,Icestingler"
      },
      {
        name: "Flower Valley",
        i: 48,
        ...
        d: "",
        m: 0,
        b: "Blossombreeze,Thistlewhisper,Petalfury,Daisyglow,Sunbeamleaf,Rosecrush,Liliespark,Sunflowershine,Wildthorn,Belladonnalure,Cherryblossom,Poppygaze,Peonypride,Orchidwaltz,Hyacinthus,Marigoldmirth,Tulipwhisper,Violetpulse,Carnationcharge,Foxgloveflight,Irisgleam,Geraniumgrace,Buttercupbliss,Snapdragonsparks,Dandeliondream,Mallowmurmur,Heliotropesun,Poppypromise,Lilypadglow,Chrysanthemumchime,Morningglorysigh,Anemonealloy,Cosmosdance,Sunchant,Nightshadeveil,Lycasenjoy,Belladonnasong,Helleborehush,Aconiteshout,Hyacinthshimmer,Veronicaflame,Violaswish,Primroseprickle,Peonyparade,Asterassembly,Daphneecho,Lilaclovely,Jasminejubilee,Rosemaryrepose,Snapdragonsmile,Marigoldmerriment"
      },
      {
        name: "Guirilla Clans",
        i: 49,
        ...
        d: "",
        m: 0,
        b: "Grimthorn,Shadowwing,Ironclaw,Frostfang,Thunderhoof,Darkscale,Bonebiter,Stormpelt,Whisperfang,Nightstalker,Razorbeak,Stoneheart,Bloodhorn,Lightningtail,Moonfury,Bonecrusher,Venomspine,Frostwhisker,Shadowspear,Ashwing,Shadowtooth,Ironwing,Bloodclaw,Stonefang,Thunderjaw,Nightshard,Frostjaw,Stormlash,Shadowthorn,Ironscale,Bloodtail,Nightfang,Stonebeak,Thunderhoof,Darkcrush,Frostbite,Shadowfang,Ashpelt,Ironwhisker,Bloodclaw,Stonebeak,Shadowclaw,Thunderhorn,Nightfury,Blackscale,Ironshard,Bloodytail,Stonetooth,Thundershadow,Shadowspine,Ironwing,Bonespear,Nightthorn,Frostpelt,Bloodfang,Stoneshard,Thunderwhisker"
      },
      {
        name: "Heartland",
        i: 50,
        ...
        d: "",
        m: 0,
        b: "Heartwhisper,Heartforge,Heartshadow,Heartfury,Heartpact,Heartstone,Heartglow,Heartveil,Heartspire,Heartreign,Hearthammer,Heartflame,Heartloom,Heartcradle,Heartgarden,Heartbough,Heartguard,Heartsheath,Heartward,Heartcrown,Heartecho,Heartwarp,Heartwhirl,Heartswell,Heartweave,Heartthrob,Heartloom,Heartroot,Heartspire,Heartshard,Heartshroud,Heartnail,Heartpalm,Heartfrost,Heartbriar,Heartgale,Heartstone,Heartloom,Heartflame,Heartwhisper,Heartforge,Heartshadow,Heartfury,Heartpact,Heartglow,Heartveil,Hearthammer,Heartflame,Heartecho,Heartwarp,Heartwhirl,Heartswell,Heartweave,Heartthrob"
      },
      {
        ...
        d: "",
        m: 0,
        b: "Glowwing,Shadowdrone,Crystal Swarm,Ironscale,Frostwhisper,HiveMind,Glintbite,EchoDrone,Spinecrusher,ShadowWing,Thunderclaw,Moonshard,Stormstinger,IronHeart,VenomWhirl,FrostWhisper,MetalWraith,ShadowNest,Glitchwing,CrystalBolt,IronShard,ShadowCleave,Glintfang,EchoStrike,MetalWisp,ShadowFlare,Glitterfang,CrystalBlight,IronSting,ShadowSpike,Glitterdrone,CrystalDusk,IronWhisper,ShadowVortex,Glintbite,CrystalGlow,IronShell,ShadowWhirl,GlitchCleave,CrystalFrost,IronWasp,ShadowWhisper,Glintfang,CrystalMist,IronHive"
      },
      {
        name: "Iron Caladra",
        i: 52,
        ...
        d: "",
        m: 0,
        b: "Ironforge,Blacksmiths' Guild,Rustfall,Girdleheim,Steeltoe,Chainheart,Anvilstrike,Ironspine,Hemlock,Grindstone,Ironwraith,Metalmaw,Ironjaw,Forgeheart,Ironclaw,Ringbreaker,Ironscale,Blademist,Ironpact,Ironroot,Rustfang,Blacksmithing's Cry,Ironshard,Irongrinder,Chainweaver,Ironsoul,Anvilshadow,Ironspine,Steelbender,Ironlash,Ironthorn,Metalmender,Ironveil,Chainfire,Ironstalker,Ironbone,Ringmaster,Ironfist,Chainbreaker,Ironwhisper,Ironshroud,Blacksmith's Dream,Ironflame,Ringweaver,Ironshadow,Chainmaster"
      },
      {
        name: "Meridian Chain",
        i: 53,
        ...
        d: "",
        m: 0,
        b: "Thunderwing,Stormfeather,Swiftbeak,Galecrest,Shadowwing,Darkplume,Whirlwind,Thunderclaw,Blazefly,Frostglide,Nightsting,Windwhisper,Stormlash,Lightningfeather,Shadowscale,Galestrike,Tempestwarp,Thunderbolt,Stormcrest,Nightshadow,Shadowflare,Thunderglide,Stormfury,Lightningwing,Thundershard,Stormrider,Nightviper,Shadowdash,Thunderstorm,Stormclaw,Nightwhirl,Thunderglory,Stormwing,Nightfury,Thunderrush,Stormstrike,Nightblade,Thunderflare,Stormspear,Nightshadow,Thunderlash,Stormshadow,Nightthunder,Thunderclaw,Stormwhip,Nightvortex,Thunderblast,Stormraven,Nightstorm"
      },
      {
        name: "Prism",
        i: 54,
        ...
        d: "",
        m: 0,
        b: "Prismate,Prismark,Prismor,Prismspire,Prismace,Prismere,Prismath,Prismsage,Prismave,Prismire,Prismine,Prismite,Prismock,Prismike,Prismoke,Prismole,Prismule,Prismile,Prismote,Prismote,Prismoke,Prismore,Prismise,Prismose,Prismese,Prismese,Prismese,Prismese,Prismese,Prismese,Prismese,Prismese,Prismese,Prismese,Prismese,Prismese,Prismese,Prismese,Prismese,Prismese,Prismese,Prismese,Prismese,Prismese,Prismese,Prismese,Prismese,Prismese,Prismese,Prismese,Prismese,Prismese,Prismese,Prismese,Prismese,Prismese,Prismese"
      },
      {
        name: "Relieance",
        i: 55,
        ...
        d: "",
        m: 0,
        b: "Rekindle,Hearthguard,Shieldspire,Echoforge,Dawnbringer,Frostveil,Ironclaw,Thunderbolt,Emberwraith,Mornstar,Stormshaper,Lightfall,Shadowweaver,Windrunner,Stonebiter,Frostwhisper,Moonfury,Nightsting,Sunblaze,Glacierkin,Thunderhoof,Blazefire,Icecrown,Shadowwhisker,Whirlwind,Frostfang,Nightshadow,Stormtalon,Fireglow,Mornwraith,Windrider,Lightforge,Ashenclaw,Emberwing,Frostbinder,Moonshard,Sunstealer,Glacierwing,Ironswallow,Thunderheart,Blazeshadow,Frostwhirl,Nightbringer,Sunfrost,Glaciertalon,Stormwhisper,Firegale,Iceblade,Shadowglide,Windspire"
      },
      {
        name: "Riverfolk",
        i: 56,
        ...
        d: "",
        m: 0,
        b: "Glimmerwing,Shadowflow,Whispercurrent,Stonefathom,Mistscourge,Ebonrush,Twilighttide,Flickerstream,Emberwhirl,Murkspire,Gloomthread,Darkweave,Vortexfall,Nightglide,Bloodsilt,Frostbraid,Ashpool,Moonshroud,Inkcurrent,Whisperroot,Shadowrapids,Glimmerdeep,Thornsweep,Drakelash,Whispertouch,Mistsnare,Shadowspindle,Flickerroot,Emberthread,Murkwhisper,Gloomflow,Nightgush,Bloodsilk,Frostweave,Ashshroud,Moonbraid,Inkrapids,Whisperpool,Shadowroot,Glimmerfathom,Thornsurgence,Drakelock,Whispertide,Mistsnarl,Shadowspire,Flickerwhirl,Emberroot,Murkglide,Gloomtouch,Nightweave"
      },
      {
        name: "Scute",
        i: 57,
        ...
        d: "",
        m: 0,
        b: "ScutumFerus,ScutaMagna,ScutaPraetoria,ScutaLegio,ScutaFortis,ScutaVigilans,ScutaProtegunt,ScutaTenebris,ScutaInsurmontabiles,ScutaImmutabilia,ScutaInflexibiles,ScutaIndestructibilia,ScutaInviabilia,ScutaImmutabilis,ScutaInvicta,ScutaInperialis,ScutaImmanes,ScutaInflexi,ScutaImpavidae,ScutaImperatoriae,ScutaInviolata,ScutaInvictae,ScutaImmutabiles,ScutaInviabiles,ScutaInflexibili,ScutaIndestructibili,ScutaInviabilii,ScutaImmutabili,ScutaInvicti,ScutaImmanesque,ScutaInperialis,ScutaInflexibilis,ScutaImpavidam,ScutaImmutabiles,ScutaInviabilibus,ScutaIndestructibilibus,ScutaInviabilibus,ScutaImmutabilibus,ScutaInvictibilia,ScutaIndestructibili,ScutaInviolabiles,ScutaInvictae,ScutaInflexibilis,ScutaImpavidam,ScutaImmutabiles,ScutaInviabilibus,ScutaIndestructibilibus,ScutaInviabilibus,ScutaImmutabilibus,ScutaInvictibilia,ScutaIndestructibili,ScutaInviolabiles,ScutaInvictae,ScutaInflexibilis,ScutaImpavidam"
      },
      {
        name: "Sumpkin",
        i: 58,
        ...
        d: "",
        m: 0,
        b: "Glimmerwing,Crystalfang,Shadowwhisper,Frostclaw,Thunderstrike,Venomsting,Bloodtail,Stormeye,Lightbane,Nightfang,Bonecrusher,Shadowhoof,Ironbeak,Shadowflame,Frostjaw,Shadowpelt,Ironspine,Whisperthorn,Thunderwing,Blackbarb,Shadowglide,Frostwhisker,Nightshadow,Stormscale,Lightstrike,Venomlash,Bloodclaw,Shadowtail,Ironwing,Whisperfang,Thunderhoof,Blackbarb,Shadowwhisker,Frostnail,Nightspine,Stormtooth,Lightfang,Venomclaw,Bloodwhisker,Shadowscale,Ironjaw,Thunderpelt,Blackspine,Shadowthorn,Frostfang,Nightwing,Stoneshadow,Ironwhisker,Thundershield,Blacktail,Shadowbeak,Frosthoof,Nightnail,Stormspine,Lighttooth,Venomtail,Bloodfang,Shadowclaw,Ironscale,Thunderpelt,Blackthorn,Shadowjaw,Frostfist,Nightwing,Stoneshadow,Ironwhisker,Thundershield,Blacktail,Shadowbeak"
      },
      {
        name: "Sylvian",
        i: 59,
        ...
        d: "",
        m: 0,
        b: "Glimmerwing,Shadowbough,Crystalroot,Moonglow,Windwhisper,Frostfang,Thundermaw,Starflight,Shadowstalker,Ironscale,Emberglide,Silverflurry,Stormfury,Galepelt,Midnightshriek,Snowspine,Frostbite,Nightwhisker,Shadowhoof,Whispertalon,Moonwhisk,Galewhisper,Shadowclaw,Frostlash,Crystalpelt,Silverbreeze,Shadowthorn,Windlash,Frostfang,Nightglide,Moonscale,Thunderbolt,Stormfeather,Galetooth,Shadowshout,Frostwhirl,Moonwhelp,Windstalker,Shadowfang,Frostwhisker,Silvershadow,Nightgale,Thunderpelt,Stormwing,Galeclaw,Shadowflame,Frostwhisper,Moonscale,Windlasher,Shadowglide,Frostwhisk,Silverstorm,Nightfury,Thundershadow,Snowgaze,Moonwhelp,Windsnarl,Shadowlash,Frostshriek,Moonglare,Thundercrest,Stormhowl,Galefang,Shadowpelt,Frostglide,Silvershadow,Nightwhirl,Windlasher,Shadowhoof,Frostwhisper,Silverflurry,Moonscale,Windstalker,Shadowclaw,Frostwhirl,Nightgale"
      },
      {
        name: "Theocracy",
        i: 60,
        ...
        d: "",
        m: 0,
        b: "Eldrida,Seraphra,Aethera,Vespera,Nefara,Xylara,Zephyra,Cerulea,Sylphria,Lumina,Astraea,Nocturna,Solara,Aeris,Caelum,Astra,Mephra,Ethora,Nyxara,Oriona,Ignara,Pyraea,Luminex,Aetherus,Celestia,Solaris,Vesperis,Nihila,Ephemera,Noctiluca,Luxoria,Aurelia,Selenia,Phosphor,Fulgura,Ignivox,Flamma,Pyromora,Radiantia,Luminara,Astralos,Celestyx,Solarion,Nocturnyx,Aurorax,Luminae,Vesperis,Ceruleanx,Aetheraea,Sylphriae,Xylarax,Zephyrax,Ceruleaex,Caelumia,Astraex,Astralys,Celestix,Solarixa,Nocturnixa,Auroraxa,Luminaria,Vesperisa,Ceruleana,Aetheraea,Sylphriae,Xylarax,Zephyrax,Ceruleaex,Caelumia,Astraex,Astralys,Celestix,Solarixa,Nocturnixa,Auroraxa,Luminaria"
      },
      {
        name: "Ursine",
        i: 61,
        ...
        d: "",
        m: 0,
        b: "Grommok,Grunthar,Gorkun,Grorath,Grognak,Gronnok,Grungur,Grimrok,Grumbol,Grondur,Gronkis,Gromgul,Gruumak,Grugron,Grotnok,Grunkis,Grungron,Grikmak,Grumork,Grungor,Gruumok,Grumbrok,Grunnok,Grumkis,Grimnok,Grunkul,Grunthor,Gronmok,Grumgul,Grugron,Grunnok,Grumkor,Grunkul,Grungor,Grumrok,Grumpak,Grumthrak,Grumtok,Grunthrak,Grumtak,Grumtok,Grungrok,Grumphak,Grungrot,Grumthak,Grumzok,Grumzug,Grumphog,Grunkog,Grunthog,Grumpog,Grumhog,Grunthok,Grumphok"
      },
      {
        name: "Vaneer",
        i: 62,
        ...
        d: "",
        m: 0,
        b: "Aetherwhisper,Borealbrow,Crystallineclaw,Echothorn,Frostgnash,Glimmerwing,Icepelt,Luminouslens,Moonfang,Nightglide,Shadowspire,Silverglint,Stormeye,Thundertail,Whisperbone,Windcall,Whirlwindtalon,Zephyrwhisker,Arcticlash,Blizzardwhistle,Chillfang,Coldglide,Frostlash,Glacialgaze,Iceclaw,Iciclespire,Morningshadow,Nightshade,Snowpelt,Stormshadow,Thunderglide,Vortexwhisper,Wintershout,Windweaver,Blizzardsnarl,Colderrow,Chillwind,Frostbite,Glaciergrin,Icegaze,Icemaul,Mistwhisker,Snowlash,Sleetwhistle,Tundraclaw,Winterglide,Windsnap,Articshout,Blizzardmaw,Coldthorn,Frostbloom,Icecrush,Icetooth,Numbglide,Snowlash,Thundershadow,Windgnash"
      }
    ];
  }
}
