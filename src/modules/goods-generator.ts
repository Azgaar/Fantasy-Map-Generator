...
export class GoodsModule {
  ...
  models = {
    ...
    Deserts_and_mountains: "biome(1, 2) || (minHeight(50) && random(10))",
    Arctic_ocean: "biome(0) && type('ocean') && maxTemp(7)",
    Desert_tundra_and_tropical_shore: "biome(1, 2, 10) || (shore(-1) && minTemp(18) && random(15))"
  };
