...
export const AUTO_BURG_LIMIT = 100001;

const LABEL_TYPES = ["state", "province", "burg", "river", "route", "added"] as const;
const LABEL_MODES = ["auto", "short", "full"] as const;
const TRANSPORT_DOMAINS = ["land", "water", "air", "flight", "rotor", "stay"] as const; // flight and rotor are fork sky transports
...
export const transport = z.strictObject({
  ...
  range: positive.optional(), // rotor only: km before it must be back at a skyport
