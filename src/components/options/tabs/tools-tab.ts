...
const TEMPLATE = /* html */ `
  ...
  <div class="grid">
    ...
    <button
      id="openAiChatButton"
      data-tip="Click to open the assistant on this map: ask about the data or edit notes with your own AI key"
    >
      Assistant
    </button>
  </div>
...
ensureEl("toolsContent").addEventListener("click", event => {
  ...
  else if (buttonId === "openAiChatButton") void Controllers.HelpAssistant.open({ mode: "map" });
