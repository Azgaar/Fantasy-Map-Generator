...
The worktree begins at the committed state of the source checkout. The source checkout's ongoing Wrap Tool changes are not copied into this branch; Space ownership must be rechecked when those changes meet.
