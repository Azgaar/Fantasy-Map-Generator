...
- **Icon slot**: A place that holds one icon reference: a good's icon, a marker's icon, a regiment's or unit type's icon, a burg group's icon, the market marker style. Every slot accepts every source. Removing a Custom icon reports how many slots use it.
