...
- Legend boxes for States, Cultures, Religions, Biomes and Zones can be shown at the same time by _[esullivan9](https://github.com/esullivan9)_ [1.151.2]
...
- Measurers Editor [1.138.0]
- Economy charts [1.125.0]

**[1.124](https://github.com/Azgaar/Fantasy-Map-Generator/archive/refs/tags/v1.124.zip) - 2026-06-17**:

- Economy [1.124.0]

**[1.123](https://github.com/Azgaar/Fantasy-Map-Generator/archive/refs/tags/v1.123.zip) - 2026-06-12**:
...
**[1.110](https://github.com/Azgaar/Fantasy-Map-Generator/archive/refs/tags/v1.110.zip) - 2026-01-22**:

- Overview dialogs search
- Codebase migration to Vite by _[SheepFromHeaven](https://github.com/SheepFromHeaven)_

From now on the tool CANNOT be run without the build step and uses Typescript for some files.

**[1.109](https://github.com/Azgaar/Fantasy-Map-Generator/archive/refs/tags/v1.109.zip) - 2026-01-09**:
