...
* _Azgaar assistant_: show or hide the help bubble in the bottom right corner. Its _Help_ tab answers questions about using the Generator; its _This map_ tab reads the world you have open and writes your notes, using your own AI provider and key.
