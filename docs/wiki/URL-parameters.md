...
* `cell` - cell id to focus on. Try [`http://azgaar.github.io/Fantasy-Map-Generator/?seed=123456789&width=1536&height=722&options=default&scale=8&cell=1000`](http://azgaar.github.io/Fantasy-Map-Generator/?seed=123456789&width=1536&height=722&options=default&scale=8&cell=1000)
...
* `layers` - comma-separated layers to show on load, other user layers will be hidden. Ids match the Layers tab (`states`, `borders`, `lakes`, `icons` for Icons, `scaleBar` for Scale Bar). If both `preset` and `layers` are set, `layers` is used. Try [`http://azgaar.github.io/Fantasy-Map-Generator/?seed=123456789&width=1536&height=722&options=default&layers=provinces,borders,lakes,rivers`](http://azgaar.github.io/Fantasy-Map-Generator/?seed=123456789&width=1536&height=722&options=default&layers=provinces,borders,lakes,rivers)
